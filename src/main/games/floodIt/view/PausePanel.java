...
public class PausePanel extends JPanel {
    ...
    public PausePanel(JPanel mainPanel, CardLayout mLayout) { // final GameController controller, final MainController
                                                              // mainController
        ...
        btnResume.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                mainLayout.show(mainPanel, "2"); // controller.resume();
            }
        });
        ...
        btnExit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.exit(0); // mainController.showMainMenu();
            }
        });
