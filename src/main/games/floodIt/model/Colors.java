...
public enum Colors {
    ...
    YELLOW(2, "Yellow", new Color(255, 211, 0)), LIME(3, "Lime", new Color(222, 255, 10)),
    GREEN(4, "Green", new Color(161, 255, 10)), LIGHT_BLUE(5, "Light Blue", new Color(10, 239, 255)),
    BLUE(6, "Blue", new Color(20, 125, 245)), INDIGO(7, "Indigo", new Color(88, 10, 255)),
    PURPLE(8, "Purple", new Color(190, 10, 255)), MAGENTA(9, "Magenta", new Color(255, 0, 84));
    ...
    public static List<Colors> getRandomColors(int n) {
        ...
        // Checks that the number of color requested doesn't exceed the maximum number
        // of colors.
    ...
    public static Colors translateColor(Color colorToTranslate) {
        ...
        List<Colors> requestedColor = colorsList.stream().filter(c -> c.getActualColor().equals(colorToTranslate))
